    ...
    <section id="about" className="py-10 px-5 text-center bg-transparent">
      ...
      <div className="flex flex-wrap gap-10 justify-center">
        {personas.map((persona) => (
          <div
            key={persona.id}
            className="flex flex-col sm:flex-row items-center sm:items-start w-full sm:w-[45%] bg-black/20 rounded-md p-5 shadow-md min-w-[300px] transition-transform duration-300 hover:scale-105 hover:shadow-xl"
          >
            ...
            <div className="flex-1 text-black text-center sm:text-left mt-4 sm:mt-0">
              ...
              <p className="text-lg font-medium leading-relaxed whitespace-normal text-white">
                {persona.descripcion}
              </p>
            </div>
          </div>
